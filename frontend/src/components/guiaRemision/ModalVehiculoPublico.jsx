...
// Componente principal del modal vehículo para transporte público
function ModalVehiculoPublico({ onClose, onVehiculoCreado }) {
  ...
  const [vehiculoData, setVehiculoData] = useState({
    ...
    año: "",
    color: "",
    tipoVehiculo: "OMNIBUS",
    modoTraslado: "TRANSPORTE_PUBLICO",
    numeroAsientos: "",
    pesoMaximo: "",
    cargaUtil: "",
    numeroEjes: "",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              🚌 Nuevo Vehículo - Transporte Público
            </h2>
            <button
              onClick={onClose}
              style={{
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px", marginBottom: "20px" }}>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Número de Tarjeta Única de Circulación"
                />
              </div>
...
export default ModalVehiculoPublico;